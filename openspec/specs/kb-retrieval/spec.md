# Specification: KB Retrieval

## Purpose
A bilingual BM25 retrieval engine searches the static knowledge base to match a user's question against the actual content of every SKILL.md section and a curated corpus of live-data intent exemplars, enabling deterministic intent classification and retrieval-based section selection.
