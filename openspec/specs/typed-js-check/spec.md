# Specification: Typed JS Check

## Purpose
Static type checking for JavaScript via TypeScript `checkJs` at ES2023 target with no build output — strict mode, ESM preserved, CI-gated — to catch shape and API regressions without converting files to TypeScript or adding a build step.
