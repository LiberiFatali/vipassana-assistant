 ...
 * Verbatim port of the original Python centers data module.
 */
 ...
 * @property {string} schedule_url_vi
 * @property {string} schedule_url_en
 * @property {string|null} maps_url
 */

/** @type {Record<string, Center>} */
export const CENTERS = {
  ...
  pala: {
    name: "Dhamma Pala",
    name_vi: "Dhamma Pala",
    subtitle: "A Vipassana meditation center in Bodh Gaya, India",
    city: "Bodh Gaya, India",
    city_vi: "Bodh Gaya, Ấn Độ",
    address: "",
    phone: "",
    email: "",
    website: "https://ucenlist.org",
    schedule_url_vi: "https://ucenlist.org/course-schedule",
    schedule_url_en: "https://ucenlist.org/en/course-schedule",
    maps_url: null,
  },
};
